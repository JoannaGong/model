<template>
  <div>
    <el-dialog :visible.sync="dialogVisible" title="积分等级" width="35%" :before-close="beforeClose">
      <el-form :model="form" ref="ruleForm" label-width="90px" :rules="rules">
        ...
        <el-form-item label="报名时间" prop="sign_up_start_time">
          <div class="min-max">
            <el-date-picker
        ...
        <el-form-item label="进行时间" prop="start_time">
          <div class="min-max">
            <el-date-picker
...
<script>
import { updateActivities, getActivitiesInfo,getUploadParams,addActivities, getProjectsList } from '@/api/table'
export default {
  props: {
    showId: {
      type: Number,
