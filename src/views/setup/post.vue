  ...
  <div class="app-container">
    <div class="search-hadle">
      <div class="search-select">
        <el-select  @change="fetchData('init')" v-model="listQuery.type" placeholder="请选择字典类型">
...
<script>
import { getDictionariesList, delDictionaries } from '@/api/table'
...
export default {
  ...
  components: {
    formDialog: () => import('./postForm.vue')
  },
  data() {
    return {
      list: null,
  ...
  methods: {
    ...
    fetchData(tag) {
      ...
      getDictionariesList(this.listQuery).then(response => {
